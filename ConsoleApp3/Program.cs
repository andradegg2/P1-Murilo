namespace ConsoleApp2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                Console.WriteLine("Digite 1 para criar conta:"); //criação de conta apertando 1
                Console.WriteLine("Digite 2 para Acessar conta:"); //acessar conta desejada apertando 2
                Console.WriteLine("Digite 3 para Listar Todas as contas:"); //lista contas apertando 3
                Console.WriteLine("Digite 4 para sair:"); //sai apertando 4
       ...
       public static void Depositar(Carteira carteira)
        {
            ...
            {
                Console.WriteLine("ação não realizada!");
            }
        }
        ...
        public static void Sacar(Carteira carteira)
        {
            ...
            {
                Console.WriteLine("ação não Realizada! contate seu gerente");
            }
        }
